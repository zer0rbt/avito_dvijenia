...
SOLIKA_FIXTURE = [
    ...
    ["", "", "", "", "", "", "", "", "", "", "", ""],
    [
        "Фото товара", "Название", "Размеры", "", "", "", "", "",
        "Цвета", "Дроп цена / ВЫКУП", "Дроп цена / БЕЗ ВЫКУПА", "ГОРОД ОТПРАВКИ ",
    ],
    ["", "", "XS", "S", "M", "L", "XL", "ХХL", "", "", "", ""],
    ["", "Stone_Island ", "❌", "✅", "❌", "✅", "✅", "❌", "Черные", "3650₽  3500₽", "3650₽  3500₽", "СОЛНЕЧНОГОРСК "],
    ["", "", "", "", "", "", "", "", "", "", "", ""],  # пустая строка-заполнитель
    ["", "Костюм Corteiz Велюр", "✅", "✅", "❌", "❌", "❌", "❌", "ЧЕРНЫЙ", "4500Р", "4650₽", "СОЛНЕЧНОГОРСК "],
]
...
BEST_DROPSHIP_FIXTURE = [
    ...
    ["", "", "S", "M", "L", "XL", "2XL", "3XL", "", "", ""],
    ["", "ХУДИ \nALEXANDER MCQUEEN", "💎", "4", "6", "7", "4", "💎", "2500", "3000", "https://t.me/best_dropship/1545"],
    ["", "ХУДИ CHAMPION", "💎", "💎", "💎", "💎", "💎", "💎", "2300", "", "https://t.me/best_dropship/2791"],
]
